...
def train(
    ...
    with tqdm(range(start_epoch, n_epochs)) as tq:
        for epoch in tq:
            ...
            if epoch % eval_freq == 0:
                ...
                with torch.no_grad():
                    ...
                    tq.set_description(f'train_loss={train_loss:.4f}, train_acc={train_acc:.4f}, test_acc={test_acc:.4f}, best_acc={best_test_acc:.4f}')
    ...
    return train_losses, train_accs, test_losses, test_accs, val_losses, val_accs, best_test_acc
